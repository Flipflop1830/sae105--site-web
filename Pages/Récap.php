<div
                    data-test-id="home"
                    class="sc-TFwJa dKnyrv styles_centeredContent__riSlJ"
                >
                    <div class="styles_leftWrapper__JUX8l">
                        <div class="apn-be">
                            <span
                                ...
                                class="teal-apn"
                                style="display: none"
                                data-google-query-id="COWVjs7fzvwCFVnK1QodV-8L4g"
                                ><div
                                    id="google_ads_iframe_/103997693/LBC-web/homepage/carte_france/Bloc_edito_0__container__"
                                    style="
                                        border: 0pt none;
                                        width: 420px;
                                        height: 0px;
                    ...
                    <div class="styles_rightWrapper__unTT3">
                        <section
                            data-test-id="FranceRegionsSelector"
                            class="styles_FranceRegionsSelector__ptUEE"
                        >
                            <div>
                                <div
                                    data-qa-id="FranceRegionsMap"
                                    data-test-id="FranceRegionsMap"
                                    class="styles_FranceRegionsMap__jrn0P"
                                >
                                    <svg
                                        version="1.1"
                                        ...
                                        y="0px"
                                        viewBox="0 0 640 700"
                                        enable-background="new 0 0 640 700"
                                        xml:space="preserve"
                                    >
                                        <g>
                                            <a>
                                                <g
                                                    data-test-id="region-1-shape"
                                                    id="alsace"
                                                    class="styles_regionLink__gFrZf"
                                                >
                                                    <path
                    ...
                    c-3.4,0-11.6,0.4-18.2-1.2C375.2,295.7,370.6,292.2,371,291.9z"
                                            ...
                                            >
                                                <g
                                                    data-test-id="region-6-shape"
                                                    id="bretagne"
                                                    class="styles_regionLink__gFrZf styles_featured__cTPon"
                                                >
                                                    <path
                    ...
                    c-0.8-0.2,2,0,5.4,2.9c3.7,3.2,5.2,8.4,9.9,10.9C256.7,283,267,282,270.3,284.8z"
                                            ...
                                            >
                                                <g
                                                    data-test-id="region-8-shape"
                                                    id="champagne_ardenne"
                                                    class="styles_regionLink__gFrZf"
                                                >
                                                    <path
                    ...
                    c-0.5-1-1.2-2-1.6-3c-0.8-2,4.3-11.5,2.8-14.7C390.7,165.9,388.9,167.5,387.2,163.5z"
                                            ...
                                            >
                                                <g
                                                    data-test-id="region-9-shape"
                                                    id="corse"
                                                    class="styles_regionLink__gFrZf styles_island__sfoGv"
                                                >
                                                    <path
                    ...
                    c8.2,6,12.8,3.7,17.4,4.1C307.3,560,311.5,566.3,312.4,567.8z"
                                            ...
                                            >
                                                <g
                                                    data-test-id="region-17-shape"
                                                    id="nord_pas_de_calais"
                                                    class="styles_regionLink__gFrZf"
                                                >
                                                    <path
                    ...
                    c2.4,0.4,4.4,1.2,5.7,1.8C193,368.5,199.7,387.1,198.8,385.2z"
                                            ...
                                            >
                                                <g
                                                    data-test-id="region-21-shape"
                                                    id="provence_alpes_cote_d_azur"
                                                    class="styles_regionLink__gFrZf styles_featured__cTPon"
                                                >
                                                    <path
