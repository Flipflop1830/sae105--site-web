...
<body>
    ...
    <div class="main">
        ...
        <ul class="lsitOfContent">
            ...
            <li class="content">
                <img src="../src/female-swimmer-holding-swimming-goggles (1).jpg" alt="" class="image" />
                <p class="titre">Lorem ipsum dolor sit amet consectetur.</p>
                <p class="description">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit, aperiam.
                </p>
            ...
            <li class="content">
                <img src="../src/img-accueil-kalypse-1.jpg" alt="" class="image" />
                <p class="titre">Lorem ipsum dolor sit amet consectetur.</p>
                <p class="description">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit, aperiam.
                </p>
            ...
            <li class="content">
                <img src="../src/medium-shot-woman-stretching-by-the-pool.jpg" alt="" class="image" />
                <p class="titre">Lorem ipsum dolor sit amet consectetur.</p>
                <p class="description">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit, aperiam.
                </p>
